...
Plane::Plane(Vector3 n, double d) { Initialize(n, d); }

Plane::Plane() : Plane(Vector3 {}, 0.0) {}

Plane::Plane(const Vector4 &plane) : Plane {Vector3 {plane[0], plane[1], plane[2]}, plane[3]} {}

Plane Plane::operator-() const { return Plane {-m_normal, -m_distance}; }
...
void Plane::SetDistance(double d) { m_distance = d; }
void Plane::SetNormal(const Vector3 &n) { m_normal = n; }
