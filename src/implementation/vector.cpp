...
void uvec::local_to_world(const Quat &localRot, Quat &ioRot) { ioRot = localRot * ioRot; }
...
void uvec::world_to_local(const Quat &localRot, Quat &ioRot) { ioRot = uquat::get_inverse(localRot) * ioRot; }
