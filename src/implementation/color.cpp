...
Color operator/(const Color &col, Float f) { return Color(static_cast<Int16>(static_cast<Float>(col.r) / f), static_cast<Int16>(static_cast<Float>(col.g) / f), static_cast<Int16>(static_cast<Float>(col.b) / f), static_cast<Int16>(static_cast<Float>(col.a) / f)); }
Color operator*(const Color &col, Float f) { return Color(static_cast<Int16>(static_cast<Float>(col.r) * f), static_cast<Int16>(static_cast<Float>(col.g) * f), static_cast<Int16>(static_cast<Float>(col.b) * f), static_cast<Int16>(static_cast<Float>(col.a) * f)); }
