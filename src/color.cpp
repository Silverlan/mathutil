...
void Color::Set(const Color &col)
{
	this->r = col.r;
	this->g = col.g;
	this->b = col.b;
...
{
	return Color {static_cast<Int16>(umath::clamp(r + umath::round((CFloat(other.r) - CFloat(r)) * factor), 0, 255)), static_cast<Int16>(umath::clamp(g + umath::round((CFloat(other.g) - CFloat(g)) * factor), 0, 255)),
	  static_cast<Int16>(umath::clamp(b + umath::round((CFloat(other.b) - CFloat(b)) * factor), 0, 255)), static_cast<Int16>(umath::clamp(a + umath::round((CFloat(other.a) - CFloat(a)) * factor), 0, 255))};
}
Color operator/(const Color &col, Float f) { return Color(CInt16(CFloat(col.r) / f), CInt16(CFloat(col.g) / f), CInt16(CFloat(col.b) / f), CInt16(CFloat(col.a) / f)); }
Color operator*(const Color &col, Float f) { return Color(CInt16(CFloat(col.r) * f), CInt16(CFloat(col.g) * f), CInt16(CFloat(col.b) * f), CInt16(CFloat(col.a) * f)); }
