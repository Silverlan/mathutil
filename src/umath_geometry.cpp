...
umath::geometry::WindingOrder umath::geometry::get_triangle_winding_order(const Vector2 &v0,const Vector2 &v1,const Vector2 &v2)
{
	return get_triangle_winding_order(Vector3{v0.x,0.f,v0.y},Vector3{v1.x,0.f,v1.y},Vector3{v2.x,0.f,v2.y},uvec::UP);
}
float umath::geometry::calc_triangle_area(const Vector3 &p0,const Vector3 &p1,const Vector3 &p2)
{
